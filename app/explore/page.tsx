        ...
        <div className='bg-gradient-to-b from-blue-50 to-purple-50 min-h-screen'>
          ...
          <div className='container mx-auto p-6'>
            <Card className='bg-white p-6 rounded-lg shadow-lg'>
                ...
                {hotel?.amenities && hotel.amenities.length > 0
                  ? hotel.amenities.map((amenity: any, index: number) => (
                      <div key={index} className='flex items-center space-x-2'>
                        {amenity.icon ? (
                          <i
                            className={`${amenity.icon} ${amenity.color} text-2xl`}
                          ></i>
                        ) : null}
              ...
              <div
                id='facilities'
                className='mt-8 p-6 bg-gradient-to-r from-red-50 to-pink-50 border border-gray-200 rounded-lg shadow-md hover:shadow-lg transition'
              >
              ...
              <div
                id='policy'
                className='mt-8 p-6 bg-gradient-to-r from-green-50 to-blue-50 border border-gray-200 rounded-lg shadow-md hover:shadow-lg transition'
              >
          ...
          <div
            ...
            className='mt-8 p-6 bg-gradient-to-r from-yellow-50 to-orange-50 border border-gray-200 rounded-lg shadow-md hover:shadow-lg transition'
          >
            <h3 className='text-xl font-semibold text-yellow-800'>
              Room Availability
            </h3>
            <p className='text-gray-600 mt-2'>
              Select your preferred room type and view the details.
            </p>
